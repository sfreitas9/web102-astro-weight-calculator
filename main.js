...
function handleClickEvent(e) {
    const wt = document.getElementById("user-weight").value;
    const planet = document.getElementById("planets").value;
    document.getElementById("output").innerHTML = `If you were on ${planet}, you would weigh ${calculateWeight(wt, planet)}lbs!`;
}

function handlePluto(e) {
